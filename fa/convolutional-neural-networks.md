...
<div dir="rtl">
گام سوم: الگوریتم فروداشت غیریبیشینه را برای حذف هر کادر مصورکننده هم‌پوشان تکراری بالقوه، اجرا کن.
</div>
...
<div dir="rtl">
[تصویر اصلی، تقسیم به GxG مشبک، پیش‌بینی کادر مصورکننده، فروداشت غیربیشبنه]
</div>
...
<div dir="rtl">
خطای سه‌گانه – خطای سه‌گانه ℓ یک تابع خطا است که بر روی بازنمایی تعبیه سه‌گانه تصاویر A (محور)، P (مثبت) و  N (منفی)  محاسبه می‌شود. نمونه‌های محور (anchor) و مثبت به دسته یکسانی تعلق دارند، حال آنکه نمونه منفی به دسته دیگری تعلق دارد. با نامیدن α∈R+ (به عنوان) فراسنج حاشیه، این خطا بصورت زیر تعریف می‌شود:
</div>
...
<div dir="rtl">
GANs شناخته می‌شوند، ترکیبی از یک مدل مولد و تمیزدهنده هستند، جاییکه مدل مولد هدفش تولید واقعی‌ترین خروجی است که به (مدل) تمیزدهنده تغذیه می‌شود و این (مدل) هدفش تفکیک بین تصویر تولیدشده و واقعی است.
</div>
